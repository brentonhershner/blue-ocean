...
class PhotosContextProvider extends Component {
  state = {
    ...
    albums:[{title: 'Really Really Long name Test Album 1', description: 'Simple Test Album', owner:'Jun', permission:0, photos: [6,7,10,12], tags: ['test1', 'test2', 'test3']},
               {title: 'Test Album 2', description: 'Simple Test Album', owner:'Jun', permission:1, photos: [1,3,6,7,10,12], tags: ['test1', 'test2', 'test3']},
               {title: 'Test Album 3', description: 'Simple Test Album', owner:'Jun', permission:2, photos: [6,7,2,9,11,10,12], tags: ['test1', 'test2', 'test3']},
